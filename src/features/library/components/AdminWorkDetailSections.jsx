                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1">
                      ...
                      <span
                        className={`inline-block px-2 py-0.5 text-[10px] font-bold uppercase rounded-md ${section.contentType === 'POETRY' ? 'bg-sky-800/10 text-sky-800' : section.contentType === 'MIXED' ? 'bg-[#834c24]/15 text-[#834c24]' : 'bg-[#ab3429]/10 text-[#ab3429]'}`}
                      >
