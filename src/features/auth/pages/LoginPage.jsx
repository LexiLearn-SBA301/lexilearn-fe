...
const ILLUSTRATION = {
  ...
  title: 'Hồn Việt Trong Từng Nét Chữ',
  description:
    'Khám phá di sản văn học ngàn năm tuổi qua lăng kính của trí tuệ nhân tạo hiện đại.',
}

export const LoginPage = () => {
  // Hook mutation đăng nhập — isPending/isError/error dùng để điều khiển UI
  ...
  const onSubmit = (data) => {
    // Gọi API đăng nhập với email và password; rememberMe không gửi lên BE
