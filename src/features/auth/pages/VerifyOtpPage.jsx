...
const ILLUSTRATION = {
  ...
  title: 'Gần đến nơi rồi',
  description:
    'Chỉ còn một bước nữa để mở ra cánh cổng vào di sản văn học ngàn năm của dân tộc.',
...
export const VerifyOtpPage = () => {
  ...
  return (
    <AuthLayout
      ...
      rightPanelClassName="w-full md:w-1/2 p-8 md:px-12 md:py-8 flex flex-col justify-center bg-bright-cream relative z-10"
      wrapContent={false}
    >
      {/* Brand Logo */}
